...
def main():
    ...
    if sys.argv[1] == 'test':
        ...
        print("Remember in origin point in FBX will represent the origin of the respective UTM zone the location is at. See `https://en.wikipedia.org/wiki/Universal_Transverse_Mercator_coordinate_system` for info.\n")
        geo = ProjGeo(args)
